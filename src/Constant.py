...
KEEPER_OFFSET_X = MARGIN_LEFT + X_POSITION_KEEPER - FIGURE_WIDTH / 2
KEEPER_OFFSET_CIRCLE_X = MARGIN_LEFT + X_POSITION_KEEPER - FIGURE_WIDTH / 2 - FIGURE_RADIUS
KEEPER_OFFSET_CIRCLE_Y = (COURT_HEIGHT - MAX_POS_KEEPER) / 2 + MARGIN_TOP - FIGURE_RADIUS
